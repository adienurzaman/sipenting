...
?>
    ...
    if(!empty($session['nama_pasien'])){

    ?>

        <title> <?php echo ucwords($session['nama_pasien']); ?> | <?php echo ucwords($session['level']); ?> | SIPENTING</title>
    ...
    ?>
        ...
        <title>SIPENTING | Sistem Pengidentifikasi Balita Stunting</title>
    ...
    <link href="<?php echo base_url('assets/bootstrap/dist/css/bootstrap.css?v=' . $version);?>" rel="stylesheet" type="text/css" >
    ...
    <link href="<?php echo base_url('assets/starrr/dist/starrr.css');?>" rel="stylesheet">    
    ...
    <link href="<?php echo base_url('assets/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css')?>" rel="stylesheet"/>
    ...
    <link href="<?php echo base_url('assets/css/custom.css') . '?v=' . $version;?>" rel="stylesheet">
