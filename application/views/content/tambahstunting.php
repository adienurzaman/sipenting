...
<script type="text/javascript">
  $(document).ready(function() {
            ...
            if (jk == 'L') {
              ...
              if (tinggi < 0) {
                ...
                if (info != "") {
                  ...
                  if ((umur == 1) && (tinggi >= 51) && (tinggi < 59)) {
                    ket = "Normal";
                  } else if ((umur == 1) && (tinggi >= 49) && (tinggi < 51)) {
                    ket = "Kurang (Stunting)";
                  } else if ((umur == 1) && (tinggi < 49)) {
                    ket = "Sangat Kurang (Stunting)";
                  } else if ((umur == 1) && (tinggi >= 59) && (tinggi < 61)) {
                    ket = "Tinngi";
                  } else if ((umur == 1) && (tinggi >= 61)) {
                    ket = "Over";
                  }

                  if ((umur == 2) && (tinggi >= 54) && (tinggi < 62)) {
                    ket = "Normal";
                  } else if ((umur == 2) && (tinggi >= 52) && (tinggi < 54)) {
                    ket = "Kurang (Stunting)";
                  } else if ((umur == 2) && (tinggi < 52)) {
                    ket = "Sangat Kurang (Stunting)";
                  } else if ((umur == 2) && (tinggi >= 62) && (tinggi < 64)) {
                    ket = "Tinngi";
                  } else if ((umur == 2) && (tinggi >= 64)) {
                    ket = "Over";
                  }
              ...
              if (tinggi < 0) {
                ...
                // alert(info);
                if (info != "") {
                  if ((umur == 1) && (tinggi >= 50) && (tinggi < 57)) {
                    ket = "Normal";
                  } else if ((umur == 1) && (tinggi >= 48) && (tinggi < 50)) {
                    ket = "Kurang (Stunting)";
                  } else if ((umur == 1) && (tinggi < 48)) {
                    ket = "Sangat Kurang (Stunting)";
                  } else if ((umur == 1) && (tinggi >= 57) && (tinggi < 60)) {
                    ket = "Tinngi";
                  } else if ((umur == 1) && (tinggi >= 60)) {
                    ket = "Over";
                  }

                  if ((umur == 2) && (tinggi >= 53) && (tinggi < 61)) {
                    ket = "Normal";
                  } else if ((umur == 2) && (tinggi >= 51) && (tinggi < 53)) {
                    ket = "Kurang (Stunting)";
                  } else if ((umur == 2) && (tinggi < 51)) {
                    ket = "Sangat Kurang (Stunting)";
                  } else if ((umur == 2) && (tinggi >= 61) && (tinggi < 63)) {
                    ket = "Tinngi";
                  } else if ((umur == 2) && (tinggi >= 63)) {
                    ket = "Over";
                  }
    ...
    function get_umur() {
      ...
      var dateString = bulanLahir + '/' + tanggalLahir + '/' + tahunLahir;
      var hasil1 = hitungUmur(dateString);
      var hasil2 = hasil1.split(",");

      var tahunTrim = hasil2[0].split(" ");
      var bulanTrim = hasil2[1].split(" ");

      if (tahunTrim[0] == "0" && bulanTrim[0] != "0") {
        $("#umur").val(bulanTrim[0]);
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "0") {
        $("#umur").val("12");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "1") {
        $("#umur").val("13");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "2") {
        $("#umur").val("14");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "3") {
        $("#umur").val("15");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "4") {
        $("#umur").val("16");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "5") {
        $("#umur").val("17");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "6") {
        $("#umur").val("18");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "7") {
        $("#umur").val("19");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "8") {
        $("#umur").val("20");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "9") {
        $("#umur").val("21");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "10") {
        $("#umur").val("22");
      }

      if (tahunTrim[0] == "1" && bulanTrim[0] == "11") {
        $("#umur").val("23");
      }

      if (tahunTrim[0] == "2" && bulanTrim[0] == "0") {
        $("#umur").val("24");
      }
    ...
    function hitungUmur(dateString) {
      ...
      if ((age.years > 0) && (age.months > 0) && (age.days > 0))
        ...
        ageString = "Baru " + age.days + dayString;
      else if ((age.years > 0) && (age.months == 0) && (age.days == 0))
        ageString = age.years + yearString + "," + age.months + monthString;
      else if ((age.years > 0) && (age.months > 0) && (age.days == 0))
        ageString = age.years + yearString + "," + age.months + monthString;
